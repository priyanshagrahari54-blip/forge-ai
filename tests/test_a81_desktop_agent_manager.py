...
from helpers_a81 import make_agent_fabric, make_project  # noqa: E402
...
def test_desktop_run_uses_the_same_engine(backend, repo):
    from helpers_a81 import AgentProvider, action_payload, write_action
